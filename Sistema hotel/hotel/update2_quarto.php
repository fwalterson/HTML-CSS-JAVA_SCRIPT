  ...
  <head>
    ...
    <fieldset>
        ...
        <div>
            ...
            <input type="text" name="standard" value="<?php echo $dados['standard'] ?>"/>
			<br><br>
            <label>Master: </label>
            <input type="text" name="master" value="<?php echo $dados['master'] ?>"/>
			<br><br>
            <label>Master-Superior: </label>
            <input type="text" name="mastersuperior" value="<?php echo $dados['mastersuperior'] ?>"/>
			<br><br>
         
		
            <input type="hidden" name='idQuartos' value="<?php echo $dados['idQuartos'] ?>">
