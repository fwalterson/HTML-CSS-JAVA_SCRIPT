						...
						<div class="row no-gutters justify-content-between">
							...
							<div class="col-lg-5">
								<div class="contact-wrap w-100 p-md-5 p-4">
									<h3 class="mb-4">QUARTOS</h3>
									<div id="form-message-warning" class="mb-4"></div> 
				      		<div id="form-message-success" class="mb-4">
				            Your message was sent, thank you!
				      		</div>
									<form  action="insert_quarto.php" method="POST" >
										<div class="row">
										<?php
										...
										if( isset($_POST) && $_POST ){
										   ...
										   $dados = array('standard' => $_POST['standard'], 'master' => $_POST['master'],'mastersuperior' => $_POST['mastersuperior'],);        
										   $insert = $conexao->insert('quartos', $dados);        
										   if($insert == true){
									...
									?>
											...
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" class="form-control" name="mastersuperior"   placeholder="Master-superior">
												</div>
											</div>
