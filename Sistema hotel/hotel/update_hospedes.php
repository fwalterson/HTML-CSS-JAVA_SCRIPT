...
h1{
    ...
    if( isset($_POST) && $_POST ){
        ...
        $dados = array('idHospedis' => 01, 'nome' => 'livro exemplo 03', 'telefone' => 'Livro de exemplo');        
        $insert = $conexao->update('hospedis', 'idHospedis', 1, $dados);        
        if($insert == true){
            echo 'alterado';
        }
    }
    ...
    <fieldset>
     <h5 style="text-align:center;">Alterar Cadastro</h5>
        <div >
            <label>Id: </label>
            <input type="text" name="idHospedis" />
            <br><br>
</div>
