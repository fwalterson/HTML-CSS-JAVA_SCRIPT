...
<style>
	...
	<?php
        ...
        $delete = $conexao->delete('funcionario', 'idFuncionario', $_POST['idFuncionario']);        
        if($delete == true){
            if(mysql_affected_rows()){
                echo 'Funcionario excluido com sucesso!';
            } else {
                echo 'Funcionario não Registrado!';
            }
        } else {
                echo 'Erro ao tentar excluir o funcionario!';
        }   
    }
    ?>
	...
	<legend>Excluir Funcionário</legend>
        <div >
            Id: <input type="text" name="idFuncionario" /><br><br>
