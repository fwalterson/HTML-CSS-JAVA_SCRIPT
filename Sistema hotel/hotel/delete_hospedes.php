...
<style>
	...
	<?php
        ...
        $delete = $conexao->delete('hospedis', 'idHospedis', $_POST['idHospedis']);        
        if($delete == true){
	...
	<section class="ftco-section img bg-hero" style="background-image: url(images/bg_1.jpg);">
					...
					<div class="box5">
						...
						<h2 style="text-align:center;">HÓSPEDES</h2>
        
    <form action="delete_hospedes.php" method="post">
    <fieldset>
	<legend>Excluir Hóspedes</legend>
        <div >
            Id: <input type="text" name="idHospedis" /><br><br>
