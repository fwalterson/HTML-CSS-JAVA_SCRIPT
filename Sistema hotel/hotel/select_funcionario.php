...
margin-left: 35%;
	...
	<section class="ftco-section img bg-hero" style="background-image: url(images/bg_1.jpg);">
        ...
        $select = $conexao->select('funcionario');        
        echo 'Lista de funcionario<br><br>';
        foreach ($select as $funcionario) {
            echo '================'.'</br>';
            echo 'Id = '.$funcionario['idFuncionario'].'</br>';
            echo 'Nome = '.$funcionario['nome'].'</br>';
            echo 'Telefone = '.$funcionario['telefone'].'</br>';
            echo 'Cargo = '.$funcionario['cargo'].'</br>';
            echo 'Setor = '.$funcionario['setor'].'</br>';
