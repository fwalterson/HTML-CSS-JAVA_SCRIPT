...
<body> 
    ...
    <div class="box">
        <form action="../index.html" method="post">
            <fieldset>
                <legend><b>Lista de  Usuario</b></legend>
                <br>
        ...
        $query_usuarios = "SELECT id, nome,idade, email ,sexo FROM usuario ORDER BY id DESC LIMIT $inicio, $limite_resultado";
        ...
        if (($result_usuarios) AND ($result_usuarios->rowCount() != 0)) {
            while ($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "<a href='editar.php?id=$id'><img src='editar3.png' ></a><br>";
                echo "<a  class='botdeletar' href='apagar.php?id=$id'><img src='excluir.png' ></a><br>";
                echo "<hr>";
            }
