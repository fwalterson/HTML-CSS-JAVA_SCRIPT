...
<?php
        ...
        if (!empty($dados['submit'])) {
            ...
            if (!$empty_input) {
                $query_usuario = "INSERT INTO vendas (marca, modelo, quantidade, preco ) VALUES (:marca,
                 :modelo, :quantidade, :preco) ";
                $cad_usuario = $conn->prepare($query_usuario);
                $cad_usuario->bindParam(':marca', $dados['marca'], PDO::PARAM_STR);
                $cad_usuario->bindParam(':modelo', $dados['modelo'], PDO::PARAM_STR);
                $cad_usuario->bindParam(':quantidade', $dados['quantidade'], PDO::PARAM_STR);
